...
`,I=["BTC","ETH","BNB","SOL","ATOM","LUNA","ALGO"],sA=[AA,eA,tA,gA,aA,iA,oA];let d=JSON.parse(localStorage.getItem("cryptoPriceMap")||"{}");const hA=new WebSocket("wss://chris-binance.herokuapp.com");hA.onmessage=o=>{const A=JSON.parse(o.data),t=B({},d);I.forEach(a=>{const g=a+"USDT";if(A[g]){const r=A[g].close>=A[g].open;t[a]={name:a,price:`$ ${Number(A[g].close).toFixed(2)}`,change:`${r?"+":""}${(A[g].close-A[g].open).toFixed(2)}`,percent:`${r?"+":""}${((A[g].close-A[g].open)/A[g].open*100).toFixed(2)} %`,isUp:r}}}),localStorage.setItem("cryptoPriceMap",JSON.stringify(t)),d=t};const pA=()=>{const[o,A]=l.exports.useState(d);return l.exports.useEffect(()=>{const t=setInterval(()=>{A(d)},1500);return()=>clearInterval(t)},[]),n(rA,{children:[n(nA,{children:[e(cA,{children:"Market"}),e(lA,{children:"more"})]}),I.map((t,a)=>{var g,r,c,h,p;return n(dA,{style:{color:"white"},children:[e("img",{src:sA[a]}),e("span",{children:t})," \xA0",e("span",{children:((g=o[t])==null?void 0:g.price)||"--"})," \xA0",e("span",{style:{color:((r=o[t])==null?void 0:r.isUp)===!1?"#f6465d":"#0caa6e"},children:((c=o[t])==null?void 0:c.change)||"--"})," \xA0",e("span",{style:{color:((h=o[t])==null?void 0:h.isUp)===!1?"#f6465d":"#0caa6e"},children:((p=o[t])==null?void 0:p.percent)||"--"})," \xA0"]},t)})]})};const wA=i.div`
  margin-bottom: 24px;
  border-radius: 16px;
  height: 310px;
  overflow: hidden;
...
`,BA=()=>e(wA,{children:e(PA,{width:424,height:330,rowHeight:50,selected:new Date,locale:{weekStartsOn:1,weekdays:["\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"]},displayOptions:{showHeader:!1,shouldHeaderAnimate:!1},theme:{accentColor:"#efb90a",floatingNav:{background:"#181a1f",chevron:"transparent",color:"#FFF"},selectionColor:"#efb90a",textColor:{active:"#FFF",default:"#FFF"},todayColor:"#efb90a",weekdayColor:"#efb90a"}})}),IA=i.div`
  margin-bottom: 12px;
  font-size: 24px;
  font-weight: bold;
  color: white;
`,CA=()=>n("div",{style:{marginBottom:"8px"},children:[e(IA,{children:"Weather"}),e("iframe",{width:"424",height:"246",src:"https://embed.windy.com/embed2.html?lat=23.536&lon=121.023&detailLat=20.303&detailLon=121.531&width=424&height=246&zoom=6&level=surface&overlay=wind&product=ecmwf&menu=&message=true&marker=&calendar=now&pressure=&type=map&location=coordinates&detail=&metricWind=default&metricTemp=default&radarRange=-1",frameBorder:"0"})]}),uA="b59f562da5497d300e7edef0d1f4a556",EA=i.div`
  height: fit-content;
  overflow: auto;
`,bA=i.div`
  margin-bottom: 12px;
...
`,UA=()=>{const[o,A]=l.exports.useState([]),t=()=>{fetch(`https://gnews.io/api/v4/search?q=\u52A0\u5BC6&country=tw&token=${uA}`).then(a=>a.json()).then(a=>{A(a.articles.slice(0,6))})};return l.exports.useEffect(()=>{t()},[]),n(EA,{children:[e(bA,{children:"News"}),o.map(a=>n(fA,{target:"_blank",href:a.url,children:[e(DA,{src:a.image}),n(mA,{children:[e("div",{children:a.title}),e("div",{children:a.description})]})]},a.url))]})},MA=i.div`
  width: 100%;
  height: 100%;
  min-height: 100vh;
`,vA=i.div`
...
`,QA=i.div`
  width: 424px;
`,XA=()=>n(MA,{className:"app",children:[e(v,{}),n(vA,{children:[n(RA,{children:[e($,{}),e(pA,{})]}),n(QA,{children:[e(BA,{}),e(CA,{}),e(UA,{})]})]})]});"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js").then(o=>console.log("ServiceWorker registration successful with scope: ",o.scope)).catch(o=>console.log("ServiceWorker registration failed: ",o))});f.render(e(XA,{}),document.getElementById("root"));
